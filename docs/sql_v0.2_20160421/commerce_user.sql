...
INSERT INTO `user` VALUES ('23', 'testinsert', '0', '3cb050720399ce26ada77f3f08461482943704a87696564f', '0', 'service_commerce1@163.com', null, '752149335751544957', '0', '3e6d599431ab7e5da51cfc4f05f25b17dc7afcf0', '2016-04-20 15:31:04', null);
...
CREATE TABLE `user_buyer` (
  `user_buyer_id` bigint(20) NOT NULL,
  PRIMARY KEY (`user_buyer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `user_seller` (
  `user_seller_id` bigint(20) NOT NULL,
  PRIMARY KEY (`user_seller_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
